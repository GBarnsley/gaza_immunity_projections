...
- Disease incidence rates are reweighted to account for population immunity (i.e. risk in S is greater than the crude rate), give equation!
...
read_csv_2("data/raw/total_pop_over_time.csv", skip = 1) %>%
    ...
    ggplot(aes(x = Year, y = Population, colour = source)) +
